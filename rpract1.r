...
grade_input=as.data.frame(read.csv("C:/Users/Rawool/Downloads/Clustering-master/Clustering-master/grades_km_input.csv"))
...
grid.arrange(arrangeGrob(g1 + theme(legend.position="none"),g2 +
                           theme(legend.position="none"),g3 + theme(legend.position="none"),top ="High School Student Cluster Analysis" ,ncol=1))
